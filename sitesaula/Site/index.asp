          ...
          <div class="col-md-6 col-lg-3 col-xs-12">
            <div class="services-item wow fadeInDown" data-wow-delay="0.3s">
              ...
              <div class="services-content">
                <h3><a href="index.asp?cod=<%=rs("cd_curso")%>#about"><%=rs("ds_curso")%></a></h3>
                <p><%=rs("resumo")%> </p>
              </div>
            </div>
          </div>
...
sql = "select * from tb_curso a inner join tb_professor b on a.cd_professor=b.cd_professor where cd_curso = "&cod
set rs = conexao.execute(sql)
            ...
            <div class="profile-wrapper wow fadeInRight" data-wow-delay="0.3s">
              ...
              <div class="about-profile">
                <ul class="admin-profile">
                  <li><span class="pro-title"> Name </span> <span class="pro-detail"><%=rs("ds_professor")%></span></li>
                  <li><span class="pro-title"> Idade </span> <span class="pro-detail"><%=idade(rs("data_nascimento"))%></span></li>
                  <li><span class="pro-title"> Cidade </span> <span class="pro-detail"><%=rs("cidade")%></span></li>
        ...
        <div class="row">
          <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            <div class="profile-wrapper wow fadeInRight" data-wow-delay="0.3s">
              <h3>Detalhes</h3>
<%
sql = "select * from tb_modulo where cd_curso = "&cod
set rs = conexao.execute(sql)
%>              
              <div class="about-profile">
                <ul class="admin-profile">
<%do while not rs.eof %>
                  <li>
                  <span class="pro-title"> <%=rs("ds_modulo")%> </span> 
                  <span class="pro-detail"><%=rs("texto")%> </span>
                  <br>
                  <span class="pro-title"> Anexo </span> 
                  <span class="pro-detail"><a href="../adm/upload/<%=rs("anexo")%>" target="_blank">Link anexo </a></span>                  
